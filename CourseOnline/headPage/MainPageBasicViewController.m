...
-(void)setUpSecond{
    ...
    scrollview.frame = CGRectMake(hOffest, 10, self.view.width - 2 * hOffest, hegith);
...
-(void)setUpCollection{
    ...
    self.mainCollectionView = [[UICollectionView alloc]initWithFrame:CGRectMake(0,0, self.view.width, self.view.height) collectionViewLayout:flowLayout];
    ...
    [self.mainCollectionView registerClass:[ContainCollectionViewCell class] forCellWithReuseIdentifier:@"ContainCollectionViewCell"];
    
    [self.mainCollectionView registerClass:[ContainScrollCollectionViewCell class] forCellWithReuseIdentifier:@"ContainScrollCollectionViewCell"];
