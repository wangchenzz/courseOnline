...
//    self.backView.backgroundColor = [UIColor redColor];
    ...
    if (popFrame.origin.y + frame.size.height <= WINDOW.height - 30) {
        self.showView.frame = CGRectMake(popFrame.origin.x, popFrame.origin.y + popFrame.size.height+1 , frame.size.width , frame.size.height );
    }
    if (popFrame.origin.y + frame.size.height > WINDOW.height - 30 ) {
        self.showView.frame = CGRectMake(popFrame.origin.x , popFrame.origin.y - frame.size.height-1, frame.size.width , frame.size.height );
    }
